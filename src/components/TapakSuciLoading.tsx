// src/components/TapakSuciLoading.tsx
// Loading skeleton untuk halaman Tapak Suci

import React from 'react';
import { Header } from '@/components/Header';

export function TapakSuciLoading() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
          ...
          <div className="w-full bg-gradient-to-t from-black/80 via-black/40 to-transparent">
            <div className="container mx-auto px-8 pb-16">
              <div className="max-w-3xl">
                {/* Title Panel Loading */}
                <div className="block">
                  <div className="bg-orange-600 inline-flex p-5">
                    <div className="h-8 bg-orange-500 rounded animate-pulse w-80"></div>
                  </div>
                </div>
                
                {/* Subtitle Panel Loading */}
                <div className="bg-orange-700 p-4 opacity-90 inline-flex rounded-b-lg">
                  <div className="h-6 bg-orange-600 rounded animate-pulse w-96"></div>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Mobile Loading */}
      <div className="w-full bg-orange-700 py-4 md:hidden">
        <div className="container mx-auto px-4">
          <div className="block">
            {/* Title Panel Loading untuk Mobile */}
            <div className="bg-orange-600 inline-flex p-3">
              <div className="h-6 bg-orange-500 rounded animate-pulse w-64"></div>
            </div>
            
            {/* Subtitle Panel Loading untuk Mobile */}
            <div className="bg-orange-700 mb-0 p-3 opacity-90 inline-flex">
              <div className="h-4 bg-orange-600 rounded animate-pulse w-72"></div>
            </div>
          </div>
        </div>
      </div>

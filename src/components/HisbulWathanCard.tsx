// src/components/HisbulWathanCard.tsx
// Komponen untuk menampilkan kartu profil pengurus Hisbul Wathan

import React from 'react';
import Image from 'next/image';
import { HisbulWathanPengurus, hisbulWathanService } from '@/services/hisbulWathanService';
import { ScrollReveal } from './ScrollReveal';
import { useI18n } from '@/hooks/useI18n';

interface HisbulWathanCardProps {
  pengurus: HisbulWathanPengurus;
  layout: 'left' | 'right';
}

export function HisbulWathanCard({ pengurus, layout }: HisbulWathanCardProps) {
  const { t } = useI18n();
  ...
  const imageSrc = hisbulWathanService.getPhotoUrl(photo, '/guru/Adam-Muttaqien-M.Si_.jpg');

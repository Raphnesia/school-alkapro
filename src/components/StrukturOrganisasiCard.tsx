...
// Komponen untuk menampilkan kartu profil struktur organisasi

import React from 'react';
import Image from 'next/image';
import { StrukturOrganisasiData } from '@/services/strukturOrganisasiService';
...
export function StrukturOrganisasiCard({ struktur, layout }: StrukturOrganisasiCardProps) {
  if (!struktur) {
    return null;
  }
